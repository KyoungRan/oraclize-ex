...
import contractBuildArtifacts from '../../build/contracts/OraclizeTest.json'

// OraclizeContract is our usable abstraction, which we'll use through the code below.
var OraclizeContract = contract(contractBuildArtifacts)
...
const App = {
  ...
  showBalance: function (price, balance) {
    ...
    balanceElement.innerHTML = parseFloat(balance).toFixed(6)

    var totalElement = document.getElementById('total')
    totalElement.innerHTML = (price * balance).toFixed(2)
  }
}
